...
namespace noa.Controllers.helpdesk
{
    public class PersonasController : Controller
    {
        ...
        public IActionResult Index(string buscaid)
        {
            ...
            return View("~/Views/helpdesk/Persona/Index.cshtml", model);
        }
        ...
        [HttpDelete]
        public async Task<bool> EliminarPersona(string deleteid)
        {
            var client = new HttpClient();
        ...
        public async Task<List<AreaDTO>> ListaArea()
        {
            var client = new HttpClient();
        ...
        [HttpGet]
        public async Task<List<EmpresaDTO>> ListaEmpresa()
        {
            var client = new HttpClient();
